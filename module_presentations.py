  ...
  ("game_credits",prsntf_read_only,mesh_load_window,[
      (ti_on_presentation_load,
       [(assign, "$g_presentation_credits_obj_1", -1),
        ...
        (assign, "$g_presentation_credits_obj_13_alpha", 0),
        (assign, "$g_presentation_credits_obj_14_alpha", 0),
        (assign, "$g_presentation_credits_obj_15_alpha", 0),
        ]),
      (ti_on_presentation_run,
	   ...
	   (else_try),
          (gt, ":cur_time", 28500),
          (lt, "$g_presentation_credits_obj_13", 0),
	  ...
	  (else_try),
          (gt, ":cur_time", 32000),
          (eq, "$g_presentation_credits_obj_13_alpha", 0),
          (assign, "$g_presentation_credits_obj_13_alpha", 1),
          (overlay_animate_to_alpha, "$g_presentation_credits_obj_13", 1000, 0),		  
	  (else_try),
          (gt, ":cur_time", 33500),
          (lt, "$g_presentation_credits_obj_14", 0),
          (str_store_string, s1, "str_credits_14"),
          (create_text_overlay, "$g_presentation_credits_obj_14", s1, tf_center_justify|tf_double_space|tf_vertical_align_center),
          (overlay_set_color, "$g_presentation_credits_obj_14", 0),
          (overlay_set_alpha, "$g_presentation_credits_obj_14", 0),
          (position_set_x, pos1, 1250),
          (position_set_y, pos1, 1250),
          (overlay_set_size, "$g_presentation_credits_obj_14", pos1),
          (position_set_x, pos1, 500),
          (position_set_y, pos1, 375),
          (overlay_set_position, "$g_presentation_credits_obj_14", pos1),
          (overlay_animate_to_alpha, "$g_presentation_credits_obj_14", 1000, 0xFF),
	  (else_try),
          (gt, ":cur_time", 37000),
          (eq, "$g_presentation_credits_obj_14_alpha", 0),
          (assign, "$g_presentation_credits_obj_14_alpha", 1),
          (overlay_animate_to_alpha, "$g_presentation_credits_obj_14", 1000, 0),	
	  (else_try),
          (gt, ":cur_time", 38500),
          (lt, "$g_presentation_credits_obj_15", 0),
          (str_store_string, s1, "str_credits_15"),
          (create_text_overlay, "$g_presentation_credits_obj_15", s1, tf_center_justify|tf_double_space|tf_vertical_align_center),
          (overlay_set_color, "$g_presentation_credits_obj_15", 0),
          (overlay_set_alpha, "$g_presentation_credits_obj_15", 0),
          (position_set_x, pos1, 1250),
          (position_set_y, pos1, 1250),
          ...
          (overlay_animate_to_alpha, "$g_presentation_credits_obj_15", 1000, 0xFF),
	  (else_try),
          (gt, ":cur_time", 42000),
          (eq, "$g_presentation_credits_obj_15_alpha", 0),
          (assign, "$g_presentation_credits_obj_15_alpha", 1),
          (overlay_animate_to_alpha, "$g_presentation_credits_obj_15", 1000, 0),	
      (else_try),
          (gt, ":cur_time", 43500),
...
#INVASION MODE END
	  ...
	  (server_set_friendly_fire_damage_friend_ratio, 1),
...
#### MOD BEGIN
      ...
      # (position_set_x, pos1, 1500),
      # (position_set_y, pos1, 1500),
      # (overlay_set_size, "$g_presentation_obj_admin_panel_46", pos1),

#COOP BEGIN############################################################
      (try_begin),
        (eq, "$coop_battle_state", coop_battle_state_setup_sp),
        (create_button_overlay, "$g_presentation_obj_admin_panel_44", "@Co-op Admin Panel", tf_center_justify),
        (position_set_x, pos1, 825),
        (position_set_y, pos1, 130),
        (overlay_set_position, "$g_presentation_obj_admin_panel_44", pos1),
        (position_set_x, pos1, 1500),
        (position_set_y, pos1, 1500),
        (overlay_set_size, "$g_presentation_obj_admin_panel_44", pos1),
      (try_end),
#COOP END#############################################################
      (presentation_set_duration, 999999),
...
## mod begin	  
	  ...
	  # (else_try),
	   ...
	   #	   (multiplayer_send_string_to_server, multiplayer_event_mod_send_string_to_server, "@map_type"),
### mod end
  ...
  ("multiplayer_escape_menu", prsntf_manual_end_only, 0, [
    (ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
	  ...
	  (assign, "$g_presentation_obj_escape_menu_invisible_on", -1),
      (assign, "$g_presentation_obj_escape_menu_invisible_off", -1),
      (try_begin),
      ...
      (try_begin),
		...
		(create_button_overlay, "$g_presentation_obj_escape_menu_invisible_on", "@Inv On", 0),
        (overlay_set_color, "$g_presentation_obj_escape_menu_invisible_on", 0xFFFFFF),
 		(create_button_overlay, "$g_presentation_obj_escape_menu_invisible_off", "@Inv OFF", 0),
        (overlay_set_color, "$g_presentation_obj_escape_menu_invisible_off", 0xFFFFFF),
     (try_end),
      ...
      (try_end),
	  (try_begin),
        (ge, "$g_presentation_obj_escape_menu_invisible_on", 0),
        #(val_sub, ":cur_y", escape_menu_item_height),
        (position_set_y, pos1, ":cur_y"),
		(position_set_x, pos1, 30),
        (overlay_set_position, "$g_presentation_obj_escape_menu_invisible_on", pos1),
	  (try_end),
      (try_begin),
        (ge, "$g_presentation_obj_escape_menu_invisible_off", 0),
        (val_sub, ":cur_y", escape_menu_item_height),
        (position_set_y, pos1, ":cur_y"),
		(position_set_x, pos1, 30),
    ...
    (ti_on_presentation_event_state_change,
     [(store_trigger_param_1, ":object"),
      ...
      (else_try),
        ...
        (start_presentation, "prsnt_multiplayer_show_players_list"),
      (else_try),
        (eq, ":object", "$g_presentation_obj_escape_menu_invisible_on"),
	    (multiplayer_get_my_player, ":my_player_no"),
		(player_get_agent_id, ":agent_admin", ":my_player_no"),
		(agent_set_visibility, ":agent_admin", 0),
		(multiplayer_send_int_to_server, multiplayer_event_set_invisible, 0),
	  (else_try),
        (eq, ":object", "$g_presentation_obj_escape_menu_invisible_off"),
	    (multiplayer_get_my_player, ":my_player_no"),
		(player_get_agent_id, ":agent_admin", ":my_player_no"),
		(agent_set_visibility, ":agent_admin", 1),
		(multiplayer_send_int_to_server, multiplayer_event_set_invisible, 1),
	  (else_try),
      ...
      (ti_on_presentation_run,
       [(try_begin),
        ...
        (try_end),
	  	  ...
	  	  ### MOD BEGIN				TO DO :			maks and min values, nubers wich are choosen, 
	  
	  	("choose_troops_values", 0, mesh_load_window, [
		(ti_on_presentation_load,[
			(set_fixed_point_multiplier, 1000),
			
			# (try_begin),
				# (eq,"$polearm_weps_last_val",0),
				# (eq,"$two_handed_weps_last_val",0),
				# (eq,"$one_handed_weps_last_val",0),
				# (eq,"$2h_throwings_last_val",0),
				# (eq,"$pole_throwings_last_val",0),
				# (eq,"$1h_shields_last_val",0),
				# (eq,"$1h_polearms_last_val",0),
				# (eq,"$1h_throwings_last_val",0),
			...
			(create_game_button_overlay, "$go_back_to_camp", "@Go back"),
			(create_game_button_overlay, ":save", "@Save"),
			(position_set_x, pos1, 850),
			(position_set_y, pos1, 50),
			(overlay_set_position, ":save", pos1),
			
			(position_set_x, pos1, 150),
			(overlay_set_position, "$go_back_to_camp", pos1),
			
			
			## sliders for main weapons
			

			# (create_slider_overlay, "$polearm_weps", 0, "$polearm_weps_max_value"),
			(create_slider_overlay, "$polearm_weps", 0, 100),
			(overlay_set_val, "$polearm_weps", "$polearm_weps_last_val"),
			(position_set_y, pos1, 420),
			(position_set_x, pos1, 770),
			(overlay_set_position, "$polearm_weps", pos1),
			
			

		#	(create_slider_overlay, "$two_handed_weps", 0, "$two_handed_weps_max_value"),
			(create_slider_overlay, "$two_handed_weps", 0, 100),
			(overlay_set_val, "$two_handed_weps", "$two_handed_weps_last_val"),
			(position_set_x, pos1, 470),
			(overlay_set_position, "$two_handed_weps", pos1),	
			
			
		
		#	(create_slider_overlay, "$one_handed_weps", 0, "$one_handed_weps_max_value"),
			(create_slider_overlay, "$one_handed_weps", 0, 100),
			(overlay_set_val, "$one_handed_weps", "$one_handed_weps_last_val"),
			(position_set_x, pos1, 150),
			(overlay_set_position, "$one_handed_weps", pos1),				
			


			#percent
			(assign,reg0,"$polearm_weps_last_val"),
			(create_text_overlay, "$polearm_weps_val", "str_reg0_percent",0),
			(position_set_x, pos1, 900),
			(overlay_set_position, "$polearm_weps_val", pos1),	
			
			(assign,reg0,"$two_handed_weps_last_val"),
			(create_text_overlay, "$two_handed_weps_val", "str_reg0_percent",0),
			(position_set_x, pos1, 600),
			(overlay_set_position, "$two_handed_weps_val", pos1),	
			
			(assign,reg0,"$one_handed_weps_last_val"),			
			(create_text_overlay, "$one_handed_weps_val", "str_reg0_percent",0),
			(position_set_x, pos1, 280),
			(overlay_set_position, "$one_handed_weps_val", pos1),	

			
			##text for main weapons
			
			(str_store_string, s1, "@Polearms"),
			(create_text_overlay, ":polearm_weps_text", s1),		
			(position_set_x, pos1, 660),
			(position_set_y, pos1, 460),
			(overlay_set_position, ":polearm_weps_text", pos1),

			
			(str_store_string, s1, "@Two handed weapons"),
			(create_text_overlay, ":two_handed_weps_text", s1),		
			(position_set_x, pos1, 360),
			(overlay_set_position, ":two_handed_weps_text", pos1),
						
			(str_store_string, s1, "@One handed weapons"),
			(create_text_overlay, ":one_handed_weps_text", s1),
			(position_set_x, pos1, 40),
			(overlay_set_position, ":one_handed_weps_text", pos1),	

	
			
			## slider for 2h secondary weapon
			(create_slider_overlay, "$2h_throwings", 0, 100),
			(overlay_set_val, "$2h_throwings", "$2h_throwings_last_val"),			
			(position_set_x, pos1, 470),
			(position_set_y, pos1, 340),
			(overlay_set_position, "$2h_throwings", pos1),

			#percent
			(assign,reg0,"$2h_throwings_last_val"),			
			(create_text_overlay, "$2h_throwings_val", "str_reg0_percent",0),
			(position_set_x, pos1, 600),
			(overlay_set_position, "$2h_throwings_val", pos1),	

			
			## text for 2h secondary weapon
			(str_store_string, s1, "@Throwing weapons"),
			(create_text_overlay, ":2h_throwings_text", s1),		
			(position_set_x, pos1, 360),
			(position_set_y, pos1, 380),
			(overlay_set_position, ":2h_throwings_text", pos1),
			
		
			## slider for polearm secondary weapon
			(create_slider_overlay, "$pole_throwings", 0, 100),			
			(overlay_set_val, "$pole_throwings", "$pole_throwings_last_val"),			
			(position_set_x, pos1, 770),			
			(position_set_y, pos1, 340),
			(overlay_set_position, "$pole_throwings", pos1),
			
			#percent
			(assign,reg0,"$pole_throwings_last_val"),				
			(create_text_overlay, "$pole_throwings_val", "str_reg0_percent",0),
			(position_set_x, pos1, 900),
			(overlay_set_position, "$pole_throwings_val", pos1),	

			## text for polearm secondary weapon
			(str_store_string, s1, "@Throwing weapons"),
			(create_text_overlay, ":pole_throwings_text", s1),		
			(position_set_x, pos1, 660),
			(position_set_y, pos1, 380),
			(overlay_set_position, ":pole_throwings_text", pos1),

					

			## sliders for 1h secondary/third weapons
			(create_slider_overlay, "$1h_shields", 0, 100),
			(overlay_set_val, "$1h_shields", "$1h_shields_last_val"),
			(position_set_x, pos1, 150),
			(position_set_y, pos1, 330),
			(overlay_set_position, "$1h_shields", pos1),
			
			#percent
			(assign,reg0,"$1h_shields_last_val"),			
			(create_text_overlay, "$1h_shields_val", "str_reg0_percent",0),
			(position_set_x, pos1, 280),
			(overlay_set_position, "$1h_shields_val", pos1),	
			
			
			(create_slider_overlay, "$1h_polearms", 0, 100),
			(overlay_set_val, "$1h_polearms", "$1h_polearms_last_val"),
			(position_set_x, pos1, 150),
			(position_set_y, pos1, 240),
			(overlay_set_position, "$1h_polearms", pos1),			
			
			#percent
			(assign,reg0,"$1h_polearms_last_val"),			
			(create_text_overlay, "$1h_polearms_val", "str_reg0_percent",0),
			(position_set_x, pos1, 280),
			(overlay_set_position, "$1h_polearms_val", pos1),	
			
			(create_slider_overlay, "$1h_throwings", 0, 100),
			(overlay_set_val, "$1h_throwings", "$1h_throwings_last_val"),
			(position_set_y, pos1, 150),
			(position_set_x, pos1, 150),
			(overlay_set_position, "$1h_throwings", pos1),			

			#percent
			(assign,reg0,"$1h_throwings_last_val"),			
			(create_text_overlay, "$1h_throwings_val", "str_reg0_percent",0),
			(position_set_x, pos1, 280),
			(overlay_set_position, "$1h_throwings_val", pos1),	

			
			## text for 1h secondary/third weapons 
			(str_store_string, s1, "@Shields"),
			(create_text_overlay, ":1h_shields_text", s1),
			(position_set_x, pos1, 40),
			(position_set_y, pos1, 370),
			(overlay_set_position, ":1h_shields_text", pos1),
			
			
			(str_store_string, s1, "@Spears"),
			(create_text_overlay, ":1h_polearms_text", s1),
			(position_set_y, pos1, 280),
			(overlay_set_position, ":1h_polearms_text", pos1),
			
			
			(str_store_string, s1, "@Throwing weapons"),
			(create_text_overlay, ":1h_throwings_text", s1),		
			(position_set_y, pos1, 190),
			(overlay_set_position, ":1h_throwings_text", pos1),
			
		
			
			## list with troops
			(create_combo_button_overlay, "$list_of_troops"),
			(position_set_x, pos1, 1200),
		    (position_set_y, pos1, 1200),
		    (overlay_set_size, "$list_of_troops", pos1),
		    (position_set_y, pos1, 650),
		    (position_set_x, pos1, 800),
		    (overlay_set_position, "$list_of_troops", pos1),
		    (try_for_range_backwards, ":cur_troop",player_troops_begin, player_troops_end),
				(try_begin),
				(neg|is_between,":cur_troop",player_ranged_begin, player_ranged_end),
					(str_store_troop_name, s0, ":cur_troop"),
					(overlay_add_item, "$list_of_troops", s0),
				(try_end),
		    (try_end),
		 ...
		 (ti_on_presentation_event_state_change,[
			...
			(try_begin),
				(eq,":object","$polearm_weps"),
				(assign,"$polearm_weps_last_val",":value"),				
				(assign,reg0,"$polearm_weps_last_val"),
				(store_add,":1h_add_2h","$two_handed_weps_max_value","$one_handed_weps_max_value"),
				(store_sub,":pole_max_val", 100, ":1h_add_2h"),
				(assign,"$polearm_weps_max_value",":pole_max_val"),
				#(overlay_set_boundaries, "$polearm_weps", 0, "$polearm_weps_max_value"),
				(overlay_set_val, "$polearm_weps", "$polearm_weps_last_val"),
				(overlay_set_text, "$polearm_weps_val", "str_reg0_percent"),
			(else_try),
				(eq,":object","$two_handed_weps"),
				(assign,"$two_handed_weps_last_val",":value"),				
				(assign,reg0,"$two_handed_weps_last_val"),
				(store_add,":1h_add_pole","$polearm_weps_max_value","$one_handed_weps_max_value"),
				(store_sub,":two_hand_max_val", 100, ":1h_add_pole"),
				(assign,"$two_handed_weps_max_value",":two_hand_max_val"),
				#(overlay_set_boundaries, "$two_handed_weps", 0, "$two_handed_weps_max_value"),
				(overlay_set_val, "$two_handed_weps", "$two_handed_weps_last_val"),				
				(overlay_set_text, "$two_handed_weps_val", "str_reg0_percent"),
			(else_try),
				(eq,":object","$one_handed_weps"),
				(assign,"$one_handed_weps_last_val",":value"),				
				(assign,reg0,"$one_handed_weps_last_val"),
				(store_add,":2h_add_pole","$polearm_weps_max_value","$two_handed_weps_max_value"),
				(store_sub,":one_hand_max_val", 100, ":2h_add_pole"),
				(assign,"$one_handed_weps_max_value",":one_hand_max_val"),	
				#(overlay_set_boundaries, "$one_handed_weps", 0, "$one_handed_weps_max_value"),
				(overlay_set_val, "$one_handed_weps", "$one_handed_weps_last_val"),			
				(overlay_set_text, "$one_handed_weps_val", "str_reg0_percent"),
			(else_try),
				(eq,":object","$2h_throwings"),
				(assign,"$2h_throwings_last_val",":value"),				
				(assign,reg0,"$2h_throwings_last_val"),
				(overlay_set_text, "$2h_throwings_val", "str_reg0_percent"),
			(else_try),
				(eq,":object","$pole_throwings"),
				(assign,"$pole_throwings_last_val",":value"),				
				(assign,reg0,"$pole_throwings_last_val"),
				(overlay_set_text, "$pole_throwings_val", "str_reg0_percent"),
			(else_try),
				(eq,":object","$1h_shields"),
				(assign,"$1h_shields_last_val",":value"),				
				(assign,reg0,"$1h_shields_last_val"),
				(overlay_set_text, "$1h_shields_val", "str_reg0_percent"),
			(else_try),
				(eq,":object","$1h_polearms"),
				(assign,"$1h_polearms_last_val",":value"),				
				(assign,reg0,"$1h_polearms_last_val"),
				(overlay_set_text, "$1h_polearms_val", "str_reg0_percent"),
			(else_try),
				(eq,":object","$1h_throwings"),
				(assign,"$1h_throwings_last_val",":value"),				
				(assign,reg0,"$1h_throwings_last_val"),
				(overlay_set_text, "$1h_throwings_val", "str_reg0_percent"),
			# (else_try),
				# (eq,":object","$list_of_troops"),
				# what will happen if troop is choosen: save values for choosen troops when hit the save
			(else_try),
				(eq,":object","$go_back_to_camp"),
				(jump_to_menu,"mnu_camp"),
			(try_end),
			
			
			
			#### TO DO:    when you set one handed weapons, two handed and polearms decrease if 1h+2h+pole = 100
			#### variables depending on choosen troop
			####
  ...
  ("name_kingdom",0,mesh_load_window,[
      (ti_on_presentation_load,
       [(set_fixed_point_multiplier, 1000),
		...
		# ### mod begin
		 (str_store_string, s2, "str_color_kingdom_text"),
         (create_text_overlay, reg2, s2, tf_center_justify),
         (position_set_x, pos1, 500),
         (position_set_y, pos1, 300),
         (overlay_set_position, reg2, pos1),
         (overlay_set_text, reg2, s2),


		 (create_combo_button_overlay, "$g_presentation_obj_color_kingdom_1"),
		 (position_set_x, pos1, 1200),
		 (position_set_y, pos1, 900),
		 (overlay_set_size, "$g_presentation_obj_color_kingdom_1", pos1),
         (position_set_x, pos1, 450),
         (position_set_y, pos1, 200),
		 (overlay_set_position, "$g_presentation_obj_color_kingdom_1", pos1),
		
		 (overlay_add_item, "$g_presentation_obj_color_kingdom_1", "str_grey"),
		 (overlay_add_item, "$g_presentation_obj_color_kingdom_1", "str_violet"),
 		 (overlay_add_item, "$g_presentation_obj_color_kingdom_1", "str_blue"),
		 (overlay_add_item, "$g_presentation_obj_color_kingdom_1", "str_yellow"), 
		 (overlay_add_item, "$g_presentation_obj_color_kingdom_1", "str_red"),
		 (overlay_add_item, "$g_presentation_obj_color_kingdom_1", "str_green"),
       
 	     (overlay_set_val, "$g_presentation_obj_color_kingdom_1", "$faction_color"),
      ...
      (ti_on_presentation_event_state_change,
       [(store_trigger_param_1, ":object"),
		...
		(else_try),		
		 ...
		 # (assign, reg8,"$faction_color"),		
		 # (assign, reg9,":value"),
		 # (display_message,"@color: {reg8}"), ## DEBUG
		 # (display_message,"@color: {reg9}"),
		  (assign,"$faction_color",":value"),
		  (try_begin),
		  (eq,":value",5),
			(faction_set_color,"fac_player_supporters_faction",0x008000),	##green	
			(overlay_set_color, "$g_presentation_obj_color_kingdom_1", 0x008000),
		  (else_try),
		  (eq,":value",4),
			(faction_set_color,"fac_player_supporters_faction",0xDC143C),	#red
			(overlay_set_color, "$g_presentation_obj_color_kingdom_1", 0xDC143C),
		  (else_try),
		  (eq,":value",3),
			(faction_set_color,"fac_player_supporters_faction",0xEEE8AA),	#yellow
			(overlay_set_color, "$g_presentation_obj_color_kingdom_1", 0xEEE8AA),
		  (else_try),
		  (eq,":value",2),
			(faction_set_color,"fac_player_supporters_faction",0x00FFFF),	#blue
			(overlay_set_color, "$g_presentation_obj_color_kingdom_1", 0x00FFFF),
		  (else_try),
		  (eq,":value",1),
			(faction_set_color,"fac_player_supporters_faction",0x9400D3),	#violet
			(overlay_set_color, "$g_presentation_obj_color_kingdom_1", 0x9400D3),
		  (else_try),
		  (eq,":value",0),
			(faction_set_color,"fac_player_supporters_faction",0xD3D3D3),	#light grey
			(overlay_set_color, "$g_presentation_obj_color_kingdom_1", 0xD3D3D3),
		  (else_try),
			(faction_set_color,"fac_player_supporters_faction",0xDDA0DD),	#default
		  (try_end),
		(else_try),
          (eq, ":object", "$g_presentation_obj_name_kingdom_2"),
          (faction_set_name, "fac_player_supporters_faction", s7),
		  #(display_message,"@{reg6}"),
...
##        (gt, ":total_wage", 0),
  ...
  ("game_party_window", 0, mesh_party_window, [		#23.10.2018
    (ti_on_presentation_load, [      
      (set_fixed_point_multiplier, 1000),
      #okno druzyny i nowy przycisk upgrade i
       #przyciski do przeniszenia wazystkich wiezniow i uwolnionych ludzi

	   #### TODO:
	   ## moving troops in party window
	   ## talking with troops
	   ## 
	   ## backup copy of party on loading presentation
	   ## reset btn: recover backup copy of party
	   ## done btn: copying from temp party to player party
	   ## displaying skill in format : 
	   ## <troop name that has the highest skill>
	   ## <Skill> (X)(+Y)
	   ## (Y - There is bonus every 2,5 points in a single skill)
	   ######
	   ## when you select companion troop:
	   ## disband button 	- ( refresh the companions number)
	   ## Weekly wage  and morale of troop above talk btn
	   ## Troop image 
	   ## move up and move down (refresh the companions order)
	   ## upgrading troop button(s) above wage and morale:
	   ## - locked if troop is not at required expandtabs
	   ## - dont appear when troop is upgraded to the maximum lvl of its upgrade tree
	   ## class of troop
	   ## - you can choose class group for troop ( small menu appearing when you click the class btn)
	   ## --- rename group btn
	   ## --- close btn
	   ## --- list of clickable groups
	   ######
	   ## when you select prisoner troop:
	   ## release prisoners btn 
	   ######
	   ## condition if its after battle menu instead of Party skills on left enemy party prisoners and realeased troops
	   ##
	   #### ADDITION to warband:
	   ## button to take all prisoners with one click - ordered by their level, 
	   ## so higher lvls as first as many as party has prisoner space
	   ## button to take all released troops to your party ordered by lvls
	   
	   
	   
	   #### skills
	  (create_text_overlay, ":party_skills", "@Party Skills"),
	  (position_set_x, pos1, 1000),
	  (position_set_y, pos1, 1000),
	  (overlay_set_size, ":party_skills", pos1),
	  (position_set_x, pos1, 120),
	  (position_set_y, pos1, 712),
	  (overlay_set_position, ":party_skills", pos1),
	  ...
	  (assign, ":starting_position",640),
	  (assign,":offset",0),
	  
	  (party_get_skill_level, reg10, "p_main_party", "skl_trade"),
	  (try_begin),
	  (gt,reg10,0),
		  (create_text_overlay, reg1, "@Trade: {reg10}"),
		  (position_set_x, pos1, 1000),
		  (position_set_y, pos1, 1000),
		  (overlay_set_size, reg1, pos1),
		  (position_set_x, pos1, 80),
		  (val_add,":starting_position",":offset"),
		  (val_add,":offset",20),
		  (position_set_y, pos1, ":starting_position"),
		  (overlay_set_position, reg1, pos1),
	  (try_end),	  
		  
	  (party_get_skill_level, reg10, "p_main_party", "skl_engineer"),
	  (try_begin),
	  (gt,reg10,0),
		  (create_text_overlay, reg1, "@Engineer: {reg10}"),
		  (position_set_x, pos1, 1000),
		  (position_set_y, pos1, 1000),
		  (overlay_set_size, reg1, pos1),
		  (position_set_x, pos1, 80),
	  ...
	  (party_get_skill_level, reg10, "p_main_party", "skl_first_aid"),
	  (try_begin),
	  (gt,reg10,0),
		  (create_text_overlay, reg1, "@First Aid: {reg10}"),
		  (position_set_x, pos1, 1000),
		  (position_set_y, pos1, 1000),
		  (overlay_set_size, reg1, pos1),
		  (position_set_x, pos1, 80),
	  ...
	  (party_get_skill_level, reg10, "p_main_party", "skl_surgery"),
	  (try_begin),
	  (gt,reg10,0),
		  (create_text_overlay, reg1, "@Surgery: {reg10}"),
		  (position_set_x, pos1, 1000),
		  (position_set_y, pos1, 1000),
		  (overlay_set_size, reg1, pos1),
		  (position_set_x, pos1, 80),
	  ...
	  (party_get_skill_level, reg10, "p_main_party", "skl_wound_treatment"),
	  (try_begin),
	  (gt,reg10,0),
		  (create_text_overlay, reg1, "@Wound Treatment: {reg10}"),
		  (position_set_x, pos1, 1000),
		  (position_set_y, pos1, 1000),
		  (overlay_set_size, reg1, pos1),
		  (position_set_x, pos1, 80),
	  ...
	  (party_get_skill_level, reg10, "p_main_party", "skl_spotting"),
	  (try_begin),
	  (gt,reg10,0),
		  (create_text_overlay, reg1, "@Spotting: {reg10}"),
		  (position_set_x, pos1, 1000),
		  (position_set_y, pos1, 1000),
		  (overlay_set_size, reg1, pos1),
		  (position_set_x, pos1, 80),
	  ...
	  (party_get_skill_level, reg10, "p_main_party", "skl_pathfinding"),
	  (try_begin),
	  (gt,reg10,0),
		  (create_text_overlay, reg1, "@Path-finding: {reg10}"),
		  (position_set_x, pos1, 1000),
		  (position_set_y, pos1, 1000),
		  (overlay_set_size, reg1, pos1),
		  (position_set_x, pos1, 80),
	  ...
	  (party_get_skill_level, reg10, "p_main_party", "skl_tactics"),
	  (try_begin),
	  (gt,reg10,0),
		  (create_text_overlay, reg1, "@Tactics: {reg10}"),
		  (position_set_x, pos1, 1000),
		  (position_set_y, pos1, 1000),
		  (overlay_set_size, reg1, pos1),
		  (position_set_x, pos1, 80),
	  ...
	  (party_get_skill_level, reg10, "p_main_party", "skl_tracking"),
	  (try_begin),
	  (gt,reg10,0),
		  (create_text_overlay, reg1, "@Tracking: {reg10}"),
		  (position_set_x, pos1, 1000),
		  (position_set_y, pos1, 1000),
		  (overlay_set_size, reg1, pos1),
		  (position_set_x, pos1, 80),
	  ...
	  (party_get_skill_level, reg10, "p_main_party", "skl_looting"),
	  (try_begin),
	  (gt,reg10,0),
		  (create_text_overlay, reg1, "@Looting: {reg10}"),
		  (position_set_x, pos1, 1000),
		  (position_set_y, pos1, 1000),
		  (overlay_set_size, reg1, pos1),
		  (position_set_x, pos1, 80),
	  ...
	  (create_text_overlay, reg1, "@Companions: {reg10}"),
	  (position_set_x, pos1, 1000),
	  (position_set_y, pos1, 1000),
	  (overlay_set_size, reg1, pos1),
	  (position_set_x, pos1, 80),
	  ...
	  (create_game_button_overlay, "$g_party_window_reset_btn", "@Reset"),	## Reset
	  (position_set_x, pos1, 120),
	  (position_set_y, pos1, 40),
	  ...
	  (create_game_button_overlay, "$g_party_window_moveUp_btn", "@Move Up"),	## move up
	  (position_set_x, pos1, 90),
	  (position_set_y, pos1, 30),
	  (overlay_set_size, "$g_party_window_moveUp_btn", pos1),
	  (position_set_x, pos1, 585),
	  (position_set_y, pos1, 630),
	  (overlay_set_position, "$g_party_window_moveUp_btn", pos1),
	  
	  (create_game_button_overlay, "$g_party_window_moveDown_btn", "@Move Down"),	# move down
	  (position_set_x, pos1, 90),
	  (position_set_y, pos1, 30),
	  (overlay_set_size, "$g_party_window_moveDown_btn", pos1),
	  (position_set_x, pos1, 585),
	  (position_set_y, pos1, 590),
	  (overlay_set_position, "$g_party_window_moveDown_btn", pos1),
	  
	  
	  ### TALK
	  
	  (create_game_button_overlay, "$g_party_window_talk_btn", "@Talk"),	# talk
	  (position_set_x, pos1, 120),
	  (position_set_y, pos1, 40),
	  (overlay_set_size, "$g_party_window_talk_btn", pos1),
	  (position_set_x, pos1, 505),
	  (position_set_y, pos1, 140),
	  (overlay_set_position, "$g_party_window_talk_btn", pos1),
	  
	  (overlay_set_display, "$g_party_window_talk_btn", 0),
	  
	  #Companions
	  
	  (party_get_num_companions,reg1,"p_main_party"),
	  (call_script,"script_game_get_party_companion_limit"),
	  (create_text_overlay, "$g_party_window_companyNum", "@Company: {reg1}/{reg0}"),	## Companions: X/Y
	  (position_set_x, pos1, 1000),
	  (position_set_y, pos1, 1000),
	  (overlay_set_size, "$g_party_window_companyNum", pos1),
	  (position_set_x, pos1, 770),
	  (position_set_y, pos1, 712),
	  (overlay_set_position, "$g_party_window_companyNum", pos1),
	  (position_set_x, pos1, 200),
	  (position_set_y, pos1, 80),
	  (overlay_set_area_size, "$g_party_window_companyNum", pos1),
	  
	  ## Prisoners
	  
	  (party_get_num_prisoners, reg2, "p_main_party"),
	  (call_script, "script_game_get_party_prisoner_limit"),
	  
	  (try_begin),
	  (eq,reg0,0),
		  (create_text_overlay, reg5, "@     You need to learn Prisoner Management skill    in order to take prisoners",tf_scrollable),	## Prisoners: X/Y
	  ...
	  (create_text_overlay, "$g_party_window_prisonersNum", "@Prisoners: {reg2}/{reg0} "),	## Prisoners: X/Y
	  (position_set_x, pos1, 1000),
	  (position_set_y, pos1, 1000),
	  (overlay_set_size, "$g_party_window_prisonersNum", pos1),
	  (position_set_x, pos1, 770),
	  (position_set_y, pos1, 260),
	  (overlay_set_position, "$g_party_window_prisonersNum", pos1),
	  ...
	  (create_text_overlay, "$g_party_window_morale_text", "@Morale: {s0} "),	## Morale: reg1
	  (position_set_x, pos1, 1000),
	  (position_set_y, pos1, 1000),
	  (overlay_set_size, "$g_party_window_morale_text", pos1),
	  (position_set_x, pos1, 680),
	  (position_set_y, pos1, 60),
	  (overlay_set_position, "$g_party_window_morale_text", pos1),
	  (overlay_set_color, "$g_party_window_morale_text", 0xF0E68C),
	  
	  (store_troop_gold,reg1,"trp_player"),
	  
	  (create_text_overlay, "$g_party_window_money_text", "@Money: {reg1} denars "),	## Money: reg1
	  (position_set_x, pos1, 1000),
	  (position_set_y, pos1, 1000),
	  (overlay_set_size, "$g_party_window_money_text", pos1),
	  (position_set_x, pos1, 680),
	  (position_set_y, pos1, 40),
	  (overlay_set_position, "$g_party_window_money_text", pos1),
	  (overlay_set_color, "$g_party_window_money_text", 0xF0E68C),	  
    ...
    (ti_on_presentation_load, [      
	  ...
	  (eq, "$character_faction", "fac_kingdom_1"),
		...
		(assign, ":end", "trp_knight_2_1"),
	  (else_try),
	  (eq, "$character_faction", "fac_kingdom_2"),
		(assign, ":begin", "trp_knight_2_1"),
		(assign, ":end", "trp_knight_3_1"),
	  (else_try),
	  (eq, "$character_faction", "fac_kingdom_3"),
		(assign, ":begin", "trp_knight_3_1"),
		(assign, ":end", "trp_knight_4_1"),
	  (else_try),
	  (eq, "$character_faction", "fac_kingdom_4"),
		(assign, ":begin", "trp_knight_4_1"),
		(assign, ":end", "trp_knight_5_1"),
	  (else_try),
	  (eq, "$character_faction", "fac_kingdom_5"),
		(assign, ":begin", "trp_knight_5_1"),
		(assign, ":end", "trp_knight_6_1"),
	  (else_try),
	  (eq, "$character_faction", "fac_kingdom_6"),
	  	(assign, ":begin", "trp_knight_6_1"),
		(assign, ":end", "trp_knight_7_1"),
	  (else_try),
	  (eq, "$character_faction", "fac_kingdom_7"),
	  	(assign, ":begin", "trp_knight_7_1"),
		(assign, ":end", "trp_knight_8_1"),
	  (else_try),
	  (eq, "$character_faction", "fac_kingdom_8"),
	  	(assign, ":begin", "trp_knight_8_1"),
		(assign, ":end", "trp_knight_9_1"),
	  (else_try),
	  (eq, "$character_faction", "fac_kingdom_9"),
	  	(assign, ":begin", "trp_knight_9_1"),
		(assign, ":end", "trp_kingdom_1_pretender"),
	  (else_try),
	  	(assign, ":begin", 0),
		(assign, ":end", 0),
		(display_message, "@ somethings wrong"),
	  (try_end),
	    ...
	    (try_for_range_backwards,":hero", ":begin", ":end"),
	  ...
	  (ti_on_presentation_event_state_change, [
		  ...
		  #(assign,reg1,":value"), 
		  #(display_message,"@ val: {reg1}"),
		 
		 # (try_begin),
		 # (eq,":object","$presentation_go_back"),
			# (presentation_set_duration, 0),
		 # (else_try),
		  ...
		  (try_end),
		   ...
		   (try_for_range,":hero", ":begin", ":end"),
				...
				(eq,":val",":value"),
					...
					(troop_get_type,":troop_type",":hero"),
		  ...
		  # (display_message,"@players kingdom: {reg1}"),
