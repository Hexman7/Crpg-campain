...
def upgrade(troops,troop1_id,troop2_id):
  ...
  if (troop1_no == -1):
    ...
    if cur_troop_length == 11:
      cur_troop[11:11] = [0, 0, 0, troop2_no, 0, 0]
    elif cur_troop_length == 12:
      cur_troop[12:12] = [0, 0, troop2_no, 0, 0]
    elif cur_troop_length == 13:
      cur_troop[13:13] = [0, troop2_no, 0, 0]
    else:
      cur_troop[14:14] = [troop2_no, 0, 0]
...
def upgrade2(troops,troop1_id,troop2_id,troop3_id):
  ...
  if (troop1_no == -1):
    ...
    cur_troop_length = len(cur_troop)
    if cur_troop_length == 11:
      cur_troop[11:11] = [0, 0, 0, troop2_no, troop3_no, 0]
    elif cur_troop_length == 12:
      cur_troop[12:12] = [0, 0, troop2_no, troop3_no, 0]
    elif cur_troop_length == 13:
      cur_troop[13:13] = [0, troop2_no, troop3_no, 0]
    else:
      cur_troop[14:14] = [troop2_no, troop3_no, 0]




def upgrade3(troops,troop1_id,troop2_id,troop3_id,troop4_id):		## mod begin
  troop1_no = find_troop(troops,troop1_id)
  troop2_no = find_troop(troops,troop2_id)
  troop3_no = find_troop(troops,troop3_id)
  ...
  if (troop1_no == -1):
    ...
    print "Error with upgrade2 def: Unable to find troop4-id: " + troop4_id
  else:
    cur_troop = troops[troop1_no]
    cur_troop_length = len(cur_troop)
  #  print(type(cur_troop))
  #  print(type(cur_troop_length))
    # for i in range(0,cur_troop_length):
       # print cur_troop[i]
  #  print "TO COS: " + str(cur_troop_length )		# mod edited 20.09.2018
    if cur_troop_length == 11:
      cur_troop[11:11] = [0, 0, 0, troop2_no, troop3_no, troop4_no]
  #    print cur_troop[11:11]
    elif cur_troop_length == 12:
      cur_troop[12:12] = [0, 0, troop2_no, troop3_no, troop4_no]
  #    print cur_troop[12:12]
    elif cur_troop_length == 13:
      cur_troop[13:13] = [0, troop2_no, troop3_no, troop4_no]
   #   print cur_troop[13:13]
    else:
      cur_troop[14:14] = [troop2_no, troop3_no, troop4_no]
   #   print cur_troop[14:14]
