...
#courtship
  ...
  ("kingdom_7_adjective",                     "Eques"),
  ("kingdom_8_adjective",                     "Norse"),
  ("kingdom_9_adjective",                     "Ode"),
...
^SiniÅ¡a VuÄkoviÄ‡ aka Zimke Zlovoljni\
...
#COOP BEGIN multiplayer_game_type ##############################################
  ("multi_game_type_10", "Co-op Battle"),
  ("multi_game_type_11", "Co-op Siege"),
#COOP END############################################################################
...
### mod begin
  ("send_data", "Send Data"),
  ("prepare_file", "Prepare Server File"),
...
### MOD BEGIN 
  ...
  ("faction_title_male_8", "Jarl {s0}"),
  ("faction_title_male_9", "Count {s0}"),
### MOD END  
...
### MOD BEGIN 
  ...
  ("faction_title_female_8", "Grevinne {s0}"),
  ("faction_title_female_9", "Countess {s0}"),
 ### MOD END 
  ("name_kingdom_text", "What will be the name of your kingdom?"),
  ("color_kingdom_text", "What will be the color of your kingdom?"),	#### mod edited 25.09.2018
  ("default_kingdom_name", "{s0}'s Kingdom"),
  ("default_kingdom_color", "0xFF7F50"),	#### mod edited 25.09.2018
