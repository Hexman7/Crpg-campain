...
### mod begin
multiplayer_event_mod_send_file_to_server_prepare			  = 49
...
multiplayer_event_return_rules							      = 59
multiplayer_event_return_server_name                          = 60
multiplayer_event_return_game_password                        = 61
multiplayer_event_return_game_type                            = 62
multiplayer_event_return_confirmation                         = 63
multiplayer_event_return_rejection                            = 64
multiplayer_event_show_multiplayer_message                    = 65
multiplayer_event_draw_this_round                             = 66
multiplayer_event_set_attached_scene_prop                     = 67
multiplayer_event_set_team_flag_situation                     = 68
multiplayer_event_set_team_score                              = 69
multiplayer_event_set_num_agents_around_flag                  = 70
multiplayer_event_ask_for_poll                                = 71
multiplayer_event_change_flag_owner                           = 72
multiplayer_event_use_item                                    = 73
multiplayer_event_set_scene_prop_open_or_close                = 74
multiplayer_event_set_round_start_time                        = 75
multiplayer_event_force_start_team_selection                  = 76
multiplayer_event_start_death_mode                            = 77
multiplayer_event_return_num_bots_voteable                    = 78
multiplayer_event_return_factions_voteable                    = 79
multiplayer_event_return_maps_voteable                        = 80
multiplayer_event_set_player_score_kill_death                 = 81
multiplayer_event_set_day_time                                = 82
multiplayer_event_return_respawn_count                        = 83
multiplayer_event_return_player_respawn_spent                 = 84
multiplayer_event_return_kick_voteable                        = 85
multiplayer_event_return_ban_voteable                         = 86
multiplayer_event_return_auto_team_balance_limit              = 87
multiplayer_event_return_renaming_server_allowed              = 88
multiplayer_event_return_changing_game_type_allowed           = 89
multiplayer_event_return_allow_player_banners                 = 90
multiplayer_event_return_force_default_armor                  = 91
multiplayer_event_return_open_game_rules                      = 92
multiplayer_event_return_max_num_bots                         = 93
multiplayer_event_return_server_mission_timer_while_player_joined = 94
multiplayer_event_show_duel_request                           = 95
multiplayer_event_start_duel                                  = 96
multiplayer_event_cancel_duel                                 = 97
multiplayer_event_show_server_message                         = 98
multiplayer_event_return_disallow_ranged_weapons              = 99
#INVASION MODE START
multiplayer_event_return_set_bot_selection                    = 100 
multiplayer_event_return_team_ratio                           = 101
multiplayer_event_return_squad_size                           = 102
multiplayer_event_return_disallow_granades                    = 103
multiplayer_event_return_sound_at_pos                         = 104
multiplayer_event_return_enable_cbf_squad_ratio				  = 105
multiplayer_event_return_cbf_squad_ratio					  = 106
multiplayer_event_coop_drop_item                              = 107
multiplayer_event_coop_chest_opened                           = 108
multiplayer_event_ccoop_victory_message                       = 109
multiplayer_event_ccoop_return_of_the_king                    = 110
#INVASION MODE END
#COOP BEGIN###################################################################################
multiplayer_event_coop_send_to_server                         = 111
multiplayer_event_coop_send_to_player                         = 112
multiplayer_event_coop_send_to_player_string                  = 113
# clients can only recieve up to multiplayer_event = 127
#COOP END#########################################################################################
multiplayer_event_mod_send_file_to_player_key                 = 114
multiplayer_event_return_invisible                 			  = 115
...
#INVASION MODE END
#COOP BEGIN################################################################
multiplayer_game_type_coop_battle            = 10
multiplayer_game_type_coop_siege             = 11
multiplayer_num_game_types                   = 12
#COOP END#####################################################################
...
multi_max_gold_that_can_be_stored = 150000	#### mod edited
