...
slot_agent_coop_spawn_party       = 29
slot_agent_coop_banner            = 30
#COOP END##################################################################    
...
slot_faction_kingsguard_troop		 = 304 #mod begin
...
#### MOD BEGIN
slot_faction_capitol = 151
slot_faction_ai_target = 152
...
slot_bridge_scene = 72  ### mod begin end
...
bridges_begin = "p_Bridge_1"
bridges_end = "p_looter_spawn_point"
...
town_senechal_begin = "trp_town_1_seneschal"
town_senechal_end = "trp_castle_1_seneschal"

castle_senechal_begin = "trp_castle_1_seneschal"
castle_senechal_end = "trp_town_1_arena_master"

player_troops_begin = "trp_player_recruit"
player_troops_end = "trp_looter"

player_ranged_begin = "trp_player_skirmisher"
player_ranged_end ="trp_player_horseman"

player_cav_begin = "trp_player_horseman"
player_cav_end = "trp_player_prison_guard"
...
boots_begin = "itm_wrapping_boots"
boots_end = "itm_sarranid_head_cloth"

light_armors_begin = "itm_shirt"
light_armors_end = "itm_padded_cloth_b"

medium_armors_begin ="itm_padded_cloth_b"
medium_armors_end ="itm_rus_scale"

heavy_armors_begin = medium_armors_end
heavy_armors_end = "itm_turret_hat_ruby"

light_helmets_begin = "itm_straw_hat"
light_helmets_end = "itm_nordic_footman_helmet"

medium_helmets_begin = light_helmets_end
medium_helmets_end = "itm_pepperpot_helmet_e"

heavy_helmets_begin = medium_helmets_end
heavy_helmets_end = "itm_sword_medieval_a"

one_handed_swords_begin = "itm_sword_medieval_a"
one_handed_swords_end ="itm_hatchet"

one_handed_axes_begin = "itm_hatchet"
one_handed_axes_end = "itm_cleaver"

one_handed_fco_begin = "itm_cleaver"
one_handed_fco_end = "itm_scimitar"

one_handed_sabres_begin = "itm_scimitar"
one_handed_sabres_end = "itm_sword_of_war"

two_handed_swords_begin = "itm_sword_of_war"
two_handed_swords_end = "itm_nailed_warclub" 

two_handed_mauls_maces_axes_begin = "itm_nailed_warclub"
two_handed_mauls_maces_axes_end = "itm_bastard_sword_a"

bastard_weapons_begin = "itm_bastard_sword_a"
bastard_weapons_end = "itm_boar_spear"

spears_and_pikes_begin = "itm_boar_spear"
spears_and_pikes_end = "itm_staff"

polearm_weapons_begin = "itm_staff"
polearm_weapons_end = "itm_jousting_lance"

lances_begin = "itm_jousting_lance"
lances_end = "itm_sickle"

throwings_begin = "itm_darts"
throwings_end = "itm_hunting_bow"

bows_begin = "itm_hunting_bow"
bows_end = "itm_hunting_crossbow"

crossbows_begin = "itm_hunting_crossbow"
crossbows_end = "itm_flintlock_pistol"

arrows_begin = "itm_arrows"
arrows_end = "itm_bolts"

bolts_begin = "itm_bolts"
bolts_end = "itm_cartridges"
...
#Mod begin
#polanie_banners_begin_offset = 0
#polanie_banners_end_offset = 20

grey_banners_begin_offset = 38	#38 because 39 is the wanted banner and it have to be greater then 38 to be 39
grey_banners_end_offset = 39


#eques_banners_begin_offset = 126
#eques_banners_end_offset = 147
#mod end
...
#COOP END##################################################################
###mod begin
mod_event_send_file_to_player					  = 52


event_return_max_num_players						= 53
event_return_next_team_faction						= 54
event_return_num_bots_in_team						= 55
event_return_anti_cheat								= 56
event_return_friendly_fire							= 57
event_return_melee_friendly_fire					= 58
event_return_friendly_fire_damage_self_ratio		= 59
event_return_friendly_fire_damage_friend_ratio		= 60
event_return_ghost_mode								= 61
event_return_control_block_dir						= 62
event_return_combat_speed							= 63
event_return_add_to_servers_list					= 64
event_return_respawn_period							= 65
event_return_game_max_minutes						= 66
event_return_round_max_seconds						= 67
event_return_player_respawn_as_bot					= 68
event_return_game_max_points						= 69
event_return_point_gained_from_flags				= 70
event_return_point_gained_from_capturing_flag		= 71
event_return_initial_gold_multiplier				= 72
event_return_battle_earnings_multiplier				= 73
event_return_round_earnings_multiplier				= 74
event_return_valid_vote_ratio						= 75
event_return_ccoop_difficulty						= 76
