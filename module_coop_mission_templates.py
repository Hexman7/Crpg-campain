...
# ###### spawning troops trigger # MOD BEGIN
	...
	# #	(neq, ":agent_no", ":player_agent"),
		...
		# # (display_message,"@jednostka odczytana {s1}"),
		
		# (str_store_troop_name,s1,":troop_no"),
	
		
		# #(try_begin),
		# #(neq,":troop_no","$last_troop_id"), # !=
			# (try_begin),
		...
		# #(else_try),
		# #	(assign,s1,":troop_no"),
		# #	(assign,s2,"$last_troop_id"),
		# #	(display_message,"@ aktualny: {s1}, ostatni: {s2}"),
		# #(try_end),
...
# # MOD END
 ...
 [
	...
	(store_trigger_param_1, ":agent_no"),
	#(display_message,"@Dedicated server"),
