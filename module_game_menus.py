...
game_menus = [
 ...
 and that whatever course you take, great adventures will await you. Drawn by the stories you hear about Calradia and its kingdoms, you...",
    ...
    [
      ("town_1",[(eq, 1,0),
	  (eq, "$current_startup_quest_phase", 0),],"join a caravan to Praven, in the Kingdom of Swadia.",
       [
...
#         (change_screen_return),
      ...
      ("town_2",[(eq, 1,0),
	  (eq, "$current_startup_quest_phase", 0),],"join a caravan to Reyvadin, in the Kingdom of the Vaegirs.",
       [
...
#         (change_screen_return),
      ...
      ("town_3",[(eq, 1,0),
	  (eq, "$current_startup_quest_phase", 0),],"join a caravan to Tulga, in the Khergit Khanate.",
       [
...
#         (change_screen_return),
      ...
      ("town_4",[(eq, 1,0),
	  (eq, "$current_startup_quest_phase", 0),],"take a ship to Sargoth, in the Kingdom of the Nords.",
       [
...
#         (change_screen_return),
      ...
      ("town_5",[(eq, 1,0),
	  (eq, "$current_startup_quest_phase", 0),],"take a ship to Jelkala, in the Kingdom of the Rhodoks.",
       [
...
#         (change_screen_return),
      ...
      ("town_6",[(eq, 1,0),
	  (eq, "$current_startup_quest_phase", 0),],"join a caravan to Shariz, in the Sarranid Sultanate.",
       [
	  ...
	  #(eq,1,0),
       ...
       [
		...
		# (party_add_members, "p_main_party", "trp_player_recruit", 10),		
		 #(party_add_members, "p_main_party", "trp_player_footman", 10),		
		 #(party_add_members, "p_main_party", "trp_player_trained_footman", 10),		
		 #(party_add_members, "p_main_party", "trp_player_infantry", 10),		
		 #(party_add_members, "p_main_party", "trp_player_elite_footman", 10),		
		 (party_add_members, "p_main_party", "trp_player_sergeant", 100),		
		 #(party_add_members, "p_main_party", "trp_player_skirmisher", 10),		
		 #(party_add_members, "p_main_party", "trp_player_archer", 10),		
		 (party_add_members, "p_main_party", "trp_player_master_archer", 100),		
		 #(party_add_members, "p_main_party", "trp_player_horseman", 10),		
		 #(party_add_members, "p_main_party", "trp_player_nobleman", 10),		
		 (party_add_members, "p_main_party", "trp_player_knight", 100),		
		 #(party_add_members, "p_main_party", "trp_player_prison_guard", 10),		
		 #(party_add_members, "p_main_party", "trp_player_castle_guard", 10),		
...
##  ),
  ...
  ("start_game_1",menu_text_color(0xFF000000)|mnf_disable_all_keys,
    ...
    [
       ...
       [
 	   ...
 	   ("start_as_king",[(eq,1,0)],"Start as Queen or King.",
       [
          (jump_to_menu, "mnu_start_character_1_crpg_campaign_2"),
       ]
       ),
	   
	   ("start_native",[],"Start as someone not known.",
       [
         (jump_to_menu,"mnu_start_native_1"),		### mod edited 24.03.2019
        ]
       ),
  ...
  # ),
    ...
    ("start_kingdom_of_polanie",[],"Polanie.",[
      (assign,"$background_type",cb_noble),
      (assign, reg3, "$character_gender"),
      (str_store_string,s10,"@You are a King of Polanie."),	### TODO: some text about kingdom.
	  (assign, "$character_faction", "fac_kingdom_1"),
	  (assign, "$current_hero","trp_kingdom_1_lord"),
    ...
    ("start_grey_order",[],"Grey Order.",[
      (assign,"$background_type",cb_noble),
      (assign, reg3, "$character_gender"),
      (str_store_string,s10,"@You are a King of Grey Order."),	### TODO: some text about kingdom.
	  (assign, "$character_faction", "fac_kingdom_2"),
	  (assign, "$current_hero","trp_kingdom_2_lord"),
	  (call_script,"script_cf_character_player_substitute"),
	  (jump_to_menu, "mnu_start_character_2_crpg_campaign"),
    ]),
    ...
    ("start_warriors_of_tengri",[],"Warriors_of_Tengri.",[
      (assign,"$background_type",cb_noble),
      (assign, reg3, "$character_gender"),
      (str_store_string,s10,"@You are a King of Warriors of Tengri."),	### TODO: some text about kingdom.
	  (assign, "$character_faction", "fac_kingdom_3"),
	  (assign, "$current_hero","trp_kingdom_3_lord"),
	  (call_script,"script_cf_character_player_substitute"),
	  (jump_to_menu, "mnu_start_character_2_crpg_campaign"),
    ]),
    ...
    ("start_kalmarunion",[],"Kalmarunion.",[
      (assign,"$background_type",cb_noble),
      (assign, reg3, "$character_gender"),
      (str_store_string,s10,"@You are a Queen of Kalmarunion."),	### TODO: some text about kingdom.
	  (assign, "$character_faction", "fac_kingdom_4"),
	  (assign, "$current_hero","trp_kingdom_4_lord"),
	  (call_script,"script_cf_character_player_substitute"),
	  (jump_to_menu, "mnu_start_character_2_crpg_campaign"),
    ]),
    ...
    ("start_druzhina",[],"Druzhina.",[
      (assign,"$background_type",cb_noble),
      (assign, reg3, "$character_gender"),
      (str_store_string,s10,"@You are a King of Druzhina."),	### TODO: some text about kingdom.
	  (assign, "$character_faction", "fac_kingdom_5"),
	  (assign, "$current_hero","trp_kingdom_5_lord"),
	  (call_script,"script_cf_character_player_substitute"),
	  (jump_to_menu, "mnu_start_character_2_crpg_campaign"),
    ]),
    ...
    ("start_templars",[],"Templars.",[
      (assign,"$background_type",cb_noble),
      (assign, reg3, "$character_gender"),
      (str_store_string,s10,"@You are a King of Templars."),	### TODO: some text about kingdom.
	  (assign, "$character_faction", "fac_kingdom_6"),
	  (assign, "$current_hero","trp_kingdom_6_lord"),
	  (call_script,"script_cf_character_player_substitute"),
	  (jump_to_menu, "mnu_start_character_2_crpg_campaign"),
    ...
    ("start_eques",[],"Eques.",[
      (assign,"$background_type",cb_noble),
      (assign, reg3, "$character_gender"),
      (str_store_string,s10,"@You are a King of Eques."),	### TODO: some text about kingdom.
	  (assign, "$character_faction", "fac_kingdom_7"),
	  (assign, "$current_hero","trp_kingdom_7_lord"),
	  (call_script,"script_cf_character_player_substitute"),
	  (jump_to_menu, "mnu_start_character_2_crpg_campaign"),
    ]),
    ...
    ("start_norse",[],"Norse.",[
      (assign,"$background_type",cb_noble),
      (assign, reg3, "$character_gender"),
      (str_store_string,s10,"@You are a King of Norse."),	### TODO: some text about kingdom.
	  (assign, "$character_faction", "fac_kingdom_8"),
	  (assign, "$current_hero","trp_kingdom_8_lord"),
	  (call_script,"script_cf_character_player_substitute"),
	  (jump_to_menu, "mnu_start_character_2_crpg_campaign"),
    ]),
    ...
    ("start_order_de_l_etoile",[],"Order de l'Etoile.",[
      (assign,"$background_type",cb_noble),
      (assign, reg3, "$character_gender"),
      (str_store_string,s10,"@You are a King of Order de l'Etoile."),	### TODO: some text about kingdom.
	  (assign, "$character_faction", "fac_kingdom_9"),
	  (assign, "$current_hero","trp_kingdom_9_lord"),
	  (call_script,"script_cf_character_player_substitute"),
	  (jump_to_menu, "mnu_start_character_2_crpg_campaign"),
    ]),
    ...
    (
    "start_character_2_crpg_campaign",mnf_disable_all_keys,
  ...
  ("start_native_1",menu_text_color(0xFF000000)|mnf_disable_all_keys,
...
##    ]),
 ...
 you wished to stay."),
	(jump_to_menu,"mnu_start_character_3"),
	 ...
	 # ("koniec",[
          # ],"A craftsman's koniec.",[
      # (assign,"$background_answer_2", cb2_koniec),
      # (assign, reg3, "$character_gender"),
      # (str_store_string,s11,"@koniec"),
...
##        (troop_set_slot, "trp_player", slot_troop_renown, 10),
	...
	# (else_try),
        # (eq,"$background_answer_2",cb2_koniec),
   ...
   [
    ...
    [
	 ...
	 ("camp_set_eatable_goods",[],"Block some of goods from being eat.",
	  ...
	  ("camp_choose_values",[
	   (eq,1,0),
	  ],"Choose per cent probability of getting items by troops",
       [
             (start_presentation, "prsnt_choose_troops_values"),
        ]
       ),
...
### MOD BEGIN
       ...
       [
	    (jump_to_menu, "mnu_camp_edit_scene_menu"),
	   ...
	   (display_message,"@troops has been saved to file"),
	   (change_screen_return),
        ],
       ),
       ...
       [ 
	   (party_get_position, pos1 ,"p_town_22"),
	   (party_get_position, pos2 ,"p_town_16"),
       ...
       [
	    ...
	    (assign,"$g_encountered_party",":capitol"),
	    (assign,"$g_player_besiege_town",":capitol"),
...
##MOD END
   ...
   ("camp_edit_scene_menu",0,
   "Edit_scene:",
   "none",
   [	
     ],
    [
	  ("edit_scene",[], "Edit Scene Bridge 1",
       [(set_jump_mission,"mt_lead_charge"),
		(jump_to_scene,"scn_bridge_scene_1"),
		(change_screen_mission),
	   ]
       ),	   
   	  ("edit_scene2",[], "Edit Scene Bridge 2",
       [(set_jump_mission,"mt_lead_charge"),
		(jump_to_scene,"scn_bridge_scene_2"),
		(change_screen_mission),
	   ]
       ),	   
   	  ("edit_scene3",[], "Edit Scene Bridge 3",
       [(set_jump_mission,"mt_lead_charge"),
		(jump_to_scene,"scn_bridge_scene_3"),
		(change_screen_mission),
	   ]
       ),	   
   	  ("edit_scene4",[], "Edit Scene Bridge 4",
       [(set_jump_mission,"mt_lead_charge"),
		(jump_to_scene,"scn_bridge_scene_4"),
		(change_screen_mission),
	   ]
       ),	   
   	  ("edit_scene5",[], "Edit Scene Bridge 5",
       [(set_jump_mission,"mt_lead_charge"),
		(jump_to_scene,"scn_bridge_scene_5"),
		(change_screen_mission),
	   ]
       ),	 

	   ("edit_scene6",[], "Edit Scene Bridge 6",
       [(set_jump_mission,"mt_lead_charge"), 
		(jump_to_scene,"scn_bridge_scene_6"),
		(change_screen_mission),
	   ]
       ),	   
   	  ("edit_scene7",[], "Edit Scene Bridge 7",
       [(set_jump_mission,"mt_lead_charge"),
		(jump_to_scene,"scn_bridge_scene_7"),
		(change_screen_mission),
	   ]
       ),	   
   	  ("edit_scene8",[], "Edit Scene Bridge 8",
       [(set_jump_mission,"mt_lead_charge"),
		(jump_to_scene,"scn_bridge_scene_8"),
		(change_screen_mission),
	   ]
       ),	   
   	  ("edit_scene9",[], "Edit Scene Bridge 9",
       [(set_jump_mission,"mt_lead_charge"),
		(jump_to_scene,"scn_bridge_scene_9"),
		(change_screen_mission),
	   ]
       ),	   
   	  ("edit_scene10",[], "Edit Scene Bridge 10",
       [(set_jump_mission,"mt_lead_charge"),
		(jump_to_scene,"scn_bridge_scene_10"),
		(change_screen_mission),
	   ]
       ),	   
   ...
   [	
    ...
    [
	  ("add_leadership",[], "Add Leadership",
       [
		 (troop_raise_skill,"trp_player","skl_leadership",10),
		 (display_message,"@ You get 10 Leadership"),
         (jump_to_menu, "mnu_camp_add_troops"),
	   ]
       ),	   

	  ("add_prison_managment",[], "Add Prison Management",
       [
		 (troop_raise_skill,"trp_player","skl_prisoner_management",10),
		 (display_message,"@ You get 10 Prison Management"),
         (jump_to_menu, "mnu_camp_add_troops"),
	   ]
       ),	   
	  ...
	  ("add_troops_1",[],"Add player Troops",
       [
		 (party_add_members,"p_main_party","trp_player_recruit",50),
		 (display_message,"@ You get 20 troops"),
         (jump_to_menu, "mnu_camp_add_troops"),		
        ]
       ),	
	   
      ("add_prisoners",[],"Add prisoners",
       [
		 (party_add_prisoners,"p_main_party","trp_looter",5),
		 (display_message,"@ You get 5 Prisoners"),
         (jump_to_menu, "mnu_camp_add_troops"),	
        ]
       ),	
	   ("add_prisoners_b",[],"Add prisoners",
       [
		 (party_add_prisoners,"p_main_party","trp_forest_bandit",5),
		 (display_message,"@ You get 5 Prisoners"),
         (jump_to_menu, "mnu_camp_add_troops"),	
        ]
       ),	
   ...
   [
    ...
    [
      ...
      ("camp_cheat_find_item",[], "Find an item...",
	   ...
	   ("camp_cheat_increase_morale",[], "Increase morale",
       [
	   ...
	   ("camp_cheat_decrease_morale",[], "Decrease morale",
       [
	     (party_get_morale, ":morale","p_main_party"),
		 (val_sub,":morale",1),
         (party_set_morale, "p_main_party", ":morale"),
  ...
  ("set_eatable_goods",0,			##### mod begin 21.09.2018
   "Choose goods to block/unlock:",
   "none",
   [
     ],
    [  
	...
	("block_category1",
       [], "Vegetable products.",
       [
		(jump_to_menu,"mnu_category1_options"),
        ],
    ),
	...
	("block_category2",
       ...
       [
		(jump_to_menu,"mnu_category2_options"),
        ],
    ),
	...
	("block_category3",
       [], "Alcohols.",
       [
		(jump_to_menu,"mnu_category3_options"),
        ],
    ),
	("block_category4",
       [], "Spices.",
       [
		(jump_to_menu,"mnu_category4_options"),
        ],
    ),
	...
	("block_bread",
       [
	    (item_get_slot,":goods_is_blocked","itm_bread",slot_item_is_blocked),
		(try_begin),
       ...
       [
		...
		(try_begin),
		(eq,":goods_is_blocked",0),
			(item_set_slot,"itm_bread",slot_item_is_blocked,1),
		(else_try),
			(item_set_slot,"itm_bread",slot_item_is_blocked,0),
		(try_end),
        ],
    ),
    ...
    ("set_eatable_goods_go_back",[],"Back to camp menu.",
       [(jump_to_menu, "mnu_camp"),
        ]
	),
   ...
   ("category1_options",0,
   "Choose what do you want to block",
   "none",
   [],
    [
		("block_cabbages",
		   [
			(item_get_slot,":goods_is_blocked","itm_cabbages",slot_item_is_blocked),
			(try_begin),
			(eq,":goods_is_blocked",0),
				(str_store_string, s1, "@Block"),
			(else_try),
		   ...
		   [
			...
			(try_begin),
			(eq,":goods_is_blocked",0),
				(item_set_slot,"itm_cabbages",slot_item_is_blocked,1),
			(else_try),
				(item_set_slot,"itm_cabbages",slot_item_is_blocked,0),
			(try_end),
			],
		),

	
		("block_raw_date_fruit",
		   [
			(item_get_slot,":goods_is_blocked","itm_raw_date_fruit",slot_item_is_blocked),
			(try_begin),
			(eq,":goods_is_blocked",0),
				(str_store_string, s1, "@Block"),
			(else_try),
		   ...
		   [
			...
			(try_begin),
			(eq,":goods_is_blocked",0),
				(item_set_slot,"itm_raw_date_fruit",slot_item_is_blocked,1),
			(else_try),
				(item_set_slot,"itm_raw_date_fruit",slot_item_is_blocked,0),
			(try_end),
			],
		),
	   ...
	   ("block_raw_olives",
		   [
			(item_get_slot,":goods_is_blocked","itm_raw_olives",slot_item_is_blocked),
			(try_begin),
			(eq,":goods_is_blocked",0),
				(str_store_string, s1, "@Block"),
			(else_try),
		   ...
		   [
			...
			(try_begin),
			(eq,":goods_is_blocked",0),
				(item_set_slot,"itm_raw_olives",slot_item_is_blocked,1),
			(else_try),
				(item_set_slot,"itm_raw_olives",slot_item_is_blocked,0),
			(try_end),
			],
		),
		...
		("block_raw_grapes",
		   [
			(item_get_slot,":goods_is_blocked","itm_raw_grapes",slot_item_is_blocked),
			(try_begin),
			(eq,":goods_is_blocked",0),
				(str_store_string, s1, "@Block"),
			(else_try),
		   ...
		   [
			...
			(try_begin),
			(eq,":goods_is_blocked",0),
				(item_set_slot,"itm_raw_grapes",slot_item_is_blocked,1),
			(else_try),
				(item_set_slot,"itm_raw_grapes",slot_item_is_blocked,0),
			(try_end),
			],
		),
		...
		("block_grain",
		   [
			(item_get_slot,":goods_is_blocked","itm_grain",slot_item_is_blocked),
			(try_begin),
			(eq,":goods_is_blocked",0),
				(str_store_string, s1, "@Block"),
			(else_try),
		   ...
		   [
			...
			(try_begin),
			(eq,":goods_is_blocked",0),
				(item_set_slot,"itm_grain",slot_item_is_blocked,1),
			(else_try),
				(item_set_slot,"itm_grain",slot_item_is_blocked,0),
			(try_end),
			],
		),
		...
		("block_apples",
		   [
			(item_get_slot,":goods_is_blocked","itm_apples",slot_item_is_blocked),
			(try_begin),
			(eq,":goods_is_blocked",0),
				(str_store_string, s1, "@Block"),
			(else_try),
		   ...
		   [
			...
			(try_begin),
			(eq,":goods_is_blocked",0),
				(item_set_slot,"itm_apples",slot_item_is_blocked,1),
			(else_try),
				(item_set_slot,"itm_apples",slot_item_is_blocked,0),
			(try_end),
			],
		),
   ...
   [],
    [
		("block_fish",
		   [
			(item_get_slot,":goods_is_blocked","itm_smoked_fish",slot_item_is_blocked),
			(try_begin),
			(eq,":goods_is_blocked",0),
				(str_store_string, s1, "@Block"),
			(else_try),
		   ...
		   [
			...
			(try_begin),
			(eq,":goods_is_blocked",0),
				(item_set_slot,"itm_smoked_fish",slot_item_is_blocked,1),
			(else_try),
				(item_set_slot,"itm_smoked_fish",slot_item_is_blocked,0),
			(try_end),
			],
		),	
		...
		("block_cheese",
		   [
			(item_get_slot,":goods_is_blocked","itm_cheese",slot_item_is_blocked),
			(try_begin),
			(eq,":goods_is_blocked",0),
				(str_store_string, s1, "@Block"),
			(else_try),
		   ...
		   [
			...
			(try_begin),
			(eq,":goods_is_blocked",0),
				(item_set_slot,"itm_cheese",slot_item_is_blocked,1),
			(else_try),
				(item_set_slot,"itm_cheese",slot_item_is_blocked,0),
			(try_end),
			],
		),	
		...
		("block_honey",
		   [
			(item_get_slot,":goods_is_blocked","itm_honey",slot_item_is_blocked),
			(try_begin),
			(eq,":goods_is_blocked",0),
				(str_store_string, s1, "@Block"),
			(else_try),
		   ...
		   [
			...
			(try_begin),
			(eq,":goods_is_blocked",0),
				(item_set_slot,"itm_honey",slot_item_is_blocked,1),
			(else_try),
				(item_set_slot,"itm_honey",slot_item_is_blocked,0),
			(try_end),
			],
		),	
		...
		("block_sausages",
		   [
			(item_get_slot,":goods_is_blocked","itm_sausages",slot_item_is_blocked),
			(try_begin),
			(eq,":goods_is_blocked",0),
				(str_store_string, s1, "@Block"),
			(else_try),
		   ...
		   [
			...
			(try_begin),
			(eq,":goods_is_blocked",0),
				(item_set_slot,"itm_sausages",slot_item_is_blocked,1),
			(else_try),
				(item_set_slot,"itm_sausages",slot_item_is_blocked,0),
			(try_end),
			],
		),
		...
		("block_dried_meat",
		   [
			(item_get_slot,":goods_is_blocked","itm_dried_meat",slot_item_is_blocked),
			(try_begin),
			(eq,":goods_is_blocked",0),
				(str_store_string, s1, "@Block"),
			(else_try),
		   ...
		   [
			...
			(try_begin),
			(eq,":goods_is_blocked",0),
				(item_set_slot,"itm_dried_meat",slot_item_is_blocked,1),
			(else_try),
				(item_set_slot,"itm_dried_meat",slot_item_is_blocked,0),
			(try_end),
			],
		),
		...
		("block_chicken",
		   [
			(item_get_slot,":goods_is_blocked","itm_chicken",slot_item_is_blocked),
			(try_begin),
			(eq,":goods_is_blocked",0),
				(str_store_string, s1, "@Block"),
			(else_try),
		   ...
		   [
			...
			(try_begin),
			(eq,":goods_is_blocked",0),
				(item_set_slot,"itm_chicken",slot_item_is_blocked,1),
			(else_try),
				(item_set_slot,"itm_chicken",slot_item_is_blocked,0),
			(try_end),
			],
		),
		...
		("block_pork",
		   [
			(item_get_slot,":goods_is_blocked","itm_pork",slot_item_is_blocked),
			(try_begin),
			(eq,":goods_is_blocked",0),
				(str_store_string, s1, "@Block"),
			(else_try),
		   ...
		   [
			...
			(try_begin),
			(eq,":goods_is_blocked",0),
				(item_set_slot,"itm_pork",slot_item_is_blocked,1),
			(else_try),
				(item_set_slot,"itm_pork",slot_item_is_blocked,0),
			(try_end),
			],
		),
		...
		("block_butter",
		   [
			(item_get_slot,":goods_is_blocked","itm_butter",slot_item_is_blocked),
			(try_begin),
			(eq,":goods_is_blocked",0),
				(str_store_string, s1, "@Block"),
			(else_try),
		   ...
		   [
			...
			(try_begin),
			(eq,":goods_is_blocked",0),
				(item_set_slot,"itm_butter",slot_item_is_blocked,1),
			(else_try),
				(item_set_slot,"itm_butter",slot_item_is_blocked,0),
			(try_end),
			],
		),
		...
		("block_cattle_meat",
		   [
			(item_get_slot,":goods_is_blocked","itm_cattle_meat",slot_item_is_blocked),
			(try_begin),
			(eq,":goods_is_blocked",0),
				(str_store_string, s1, "@Block"),
			(else_try),
		   ...
		   [
			...
			(try_begin),
			(eq,":goods_is_blocked",0),
				(item_set_slot,"itm_cattle_meat",slot_item_is_blocked,1),
			(else_try),
				(item_set_slot,"itm_cattle_meat",slot_item_is_blocked,0),
			(try_end),
			],
		),
   ...
   [],
    [
		("block_wine",
		   [
			(item_get_slot,":goods_is_blocked","itm_wine",slot_item_is_blocked),
			(try_begin),
			(eq,":goods_is_blocked",0),
				(str_store_string, s1, "@Block"),
			(else_try),
		   ...
		   [
			...
			(try_begin),
			(eq,":goods_is_blocked",0),
				(item_set_slot,"itm_wine",slot_item_is_blocked,1),
			(else_try),
				(item_set_slot,"itm_wine",slot_item_is_blocked,0),
			(try_end),
			],
		),
		...
		("block_ale",
		   [
			(item_get_slot,":goods_is_blocked","itm_ale",slot_item_is_blocked),
			(try_begin),
			(eq,":goods_is_blocked",0),
				(str_store_string, s1, "@Block"),
			(else_try),
		   ...
		   [
			...
			(try_begin),
			(eq,":goods_is_blocked",0),
				(item_set_slot,"itm_ale",slot_item_is_blocked,1),
			(else_try),
				(item_set_slot,"itm_ale",slot_item_is_blocked,0),
			(try_end),
			],
		),
   ...
   [],
    [
		...
		("block_spice",
		   [
			(item_get_slot,":goods_is_blocked","itm_spice",slot_item_is_blocked),
			(try_begin),
			(eq,":goods_is_blocked",0),
				(str_store_string, s1, "@Block"),
			(else_try),
		   ...
		   [
			...
			(try_begin),
			(eq,":goods_is_blocked",0),
				(item_set_slot,"itm_spice",slot_item_is_blocked,1),
			(else_try),
				(item_set_slot,"itm_spice",slot_item_is_blocked,0),
			(try_end),
			],
		),
		...
		("block_salt",
		   [
			(item_get_slot,":goods_is_blocked","itm_salt",slot_item_is_blocked),
			(try_begin),
			(eq,":goods_is_blocked",0),
				(str_store_string, s1, "@Block"),
			(else_try),
		   ...
		   [
			...
			(try_begin),
			(eq,":goods_is_blocked",0),
				(item_set_slot,"itm_salt",slot_item_is_blocked,1),
			(else_try),
				(item_set_slot,"itm_salt",slot_item_is_blocked,0),
			(try_end),
			],
		),
 ...
 Try as you might, it soon gives you a headache, and you're forced to give up the attempt."),
  ...
  ("retirement_verify",0,
   ...
   ("reset_stats_menu",0,
   "You can reset your character stats only 2 times.",
   "none",
   [(lt,"$stats_reset",3),
    ],
    [
      ("reset_stats_menu_accept",[],"Reset.",
       [
		(call_script,"script_reset_hero_stats","trp_player"),
		(val_add,"$stats_reset",1),
		(display_message,"@Your character stats has been reset"),
        (jump_to_menu, "mnu_camp"),
        ]
       ),
      ("reset_stats_go_back",[],"Go back.",
       [(jump_to_menu, "mnu_camp"),
        ]
       ),
      ]
    ...
    [
      ("cattle_drive_away",[],"Drive the cattle onward.",
       [
        ...
        (party_set_ai_behavior, "$g_encountered_party", ai_bhvr_escort_party),	#mod begin
...
#          (try_end),
    ...
    [
      ...
      [
		...
		(call_script, "script_check_bridge_nearby"),#mod	begin 20.04.2018	end#
  ...
  (
    ...
    [
        ...
        (else_try),                 
		  ...
		  (call_script, "script_party_add_party", "p_total_enemy_casualties", "p_total_enemy_casualties_2"),## mod begin 21.11.2018
		  (party_get_num_prisoner_stacks,reg31,"p_total_enemy_casualties"),
		  (party_get_num_prisoner_stacks,reg30,"p_total_enemy_casualties_2"),
		 # (display_message,"@casaulties2 :{reg30}, casaulties1: {reg31}"),
          (call_script, "script_party_add_wounded_members_as_prisoners", "p_temp_party", "p_total_enemy_casualties"),
          
		  ### here is the problem with wounded ppl that are in party before fight		mod
  ...
  (
    ...
    [
      ("pre_join_help_attackers",[
          ...
          (ge, ":attacker_relation", -10),	##28.04.2018
          (lt, ":defender_relation", 10),##28.04.2018
          ],
      ...
      ("pre_join_help_defenders",[
          ...
          (store_faction_of_party, ":defender_faction", "$g_encountered_party"),
          (store_relation, ":defender_relation", ":defender_faction", "fac_player_supporters_faction"),
          (ge, ":defender_relation", -10),##28.04.2018
          (lt, ":attacker_relation", 10),##28.04.2018
          ],
...
#          (assign, "$waiting_for_arena_fight_result", 0),
        ...
        (try_begin), # same mnu_town
          ...
          (else_try),
			(eq, ":center_lord", "trp_kingdom_neutral_lord"),
			(str_store_string,s11,"@ You can't see any banners."),
          (else_try),
            (ge, ":center_lord", 0),
...
##          (change_screen_map_conversation, ":cur_lord"),
        ...
        (else_try),
          ...
          (neq,"$g_encountered_party_faction","fac_neutrals"),
...
##                                                   (change_screen_map_conversation, ":cur_guard")
     ...
     # ("castle_start_siege_crpgmod",
       # [
           ...
           # (try_end),
           # ],
       # "Besiege the {reg6?town:castle} (!)  in progress.",
       # [
         # (assign,"$g_player_besiege_town","$g_encountered_party"),
         # (store_relation, ":relation", "fac_player_supporters_faction", "$g_encountered_party_faction"),
         # (val_min, ":relation", -40),
         # (call_script, "script_set_player_relation_with_faction", "$g_encountered_party_faction", ":relation"),
         # (call_script, "script_update_all_notes"),
         # (jump_to_menu, "mnu_castle_besiege_crpg_mod"),
         # ]),
...
##           (set_battle_advantage, reg0),
           (set_party_battle_mode),
           (jump_to_scene, ":battle_scene"),
		   (eq,"$g_battle_result",1),	#mod edit 19.09.2018
...
{reg1? You may station troops here to defend it against enemies who may try to recapture it. Also, you should select now whether you will hold the {reg2?town:castle} yourself or give it to a faithful vassal...:}",# Only visible when castle is taken without being a vassal of a kingdom.
    ...
    [
        ...
        (try_begin),        
          ...
          #(neq, ":new_owner", "trp_player"),		## mod edited 25.09.2018
...
(
 ...
 ",
    ...
    [(set_background_mesh, "mesh_pic_messenger"),
     ...
     (assign, reg6, 3000),	# mod edited 19.09.2018	was 900
...
#              (eq, ":num_enemy_regulars_remaining", 0), #battle won (sdsd = TODO : compare with num_routed_us)
              (this_or_next|le, ":num_enemy_regulars_remaining", 0), #battle won
              (le, ":num_enemy_regulars_remaining",  "$num_routed_enemies"), #replaced for above line because we do not want routed agents to spawn again in next turn of battle.
#COOP END##########################              (assign, ":enemy_finished",1),
            (else_try),
              (eq, "$g_engaged_enemy", 1),
#COOP BEGIN bugfix ##############
#              (le, "$g_enemy_fit_for_battle",0),
...
#COOP END#################################################			  
  ...
  (
    ...
    [
        ...
        (else_try),
		  (eq, ":center_lord", "trp_kingdom_neutral_lord"),
		  (str_store_string,s11,"@ This village and the surrounding lands belong Neutrals"), ##mod edited
        (else_try),
          (ge, ":center_lord", 0),
    ...
    [
      ...
      ("village_center",[(neg|party_slot_eq, "$current_town", slot_village_state, svs_looted),
       ...
       [
		...
		### mod begin 	# 20.09.2018
	 ("met_the_village_elder",[
						(party_slot_eq, "$current_town", slot_party_type, spt_village),
						(party_get_slot, ":scene", "$current_town", slot_castle_exterior),	### mod edited 20.09.2018
						(try_begin),
						(scene_slot_eq, ":scene", slot_scene_visited, 0), #check if scene has been visited before to allow entry from menu. Otherwise scene will only be accessible from the town center.
							(disable_menu_option),
						(try_end),
	 ...
	 ],"That shouldn't be shown,Village Elder"),
...
### MOD END
 ...
 #### mod begin
	  ...
	  ("center_build_large_bowyer",[(eq, reg6, 0),
	  ...
	  ("center_build_kings_bowyer",[(eq, reg6, 0),
       ...
       [
         ...
         (else_try),
          ...
          # (try_begin),
           ...
           (try_end),
			### mod begin 20.09.2018
			(party_get_slot, ":cur_scene", "$current_town", slot_town_alley),
...
##          ]),
      ...
      "Give away prisoners.",
      [
		(party_get_num_prisoner_stacks,":number_of_stacks","p_main_party"),
	#	(assign, reg1, ":number_of_stacks"),
	#	(display_message,"@{!}DEBUG: Ilosc stackow {reg1}"),
		(try_for_range,":stack_no", 0, ":number_of_stacks"),
			(party_prisoner_stack_get_troop_id,":stack_troop", "p_main_party", ":stack_no"),
			(neg|troop_is_hero, ":stack_troop"),	
			(party_count_prisoners_of_type, ":number_of_prioners","p_main_party",":stack_troop"),
			(party_add_prisoners,"$g_encountered_party",":stack_troop",":number_of_prioners"),
	#		(assign, reg0, ":number_of_prioners" ),	
	#		(display_message,"@{!}DEBUG: Ilosc wiezniow {reg0}"),	
	#		(assign, reg2, ":stack_troop" ),	
	#		(display_message,"@{!}DEBUG:  stack_troop {reg2}"),				
	#		(display_message,"@{!}DEBUG: Ilosc wiezniow {reg0}"),	
			
			######@! have to be fixed for not abusing with sell looters for 30 per one
			(assign,":ilu", ":number_of_prioners"),
			(val_mul,":ilu", 30),
			(troop_add_gold,"trp_player", ":ilu"),
		(try_end),
	  ...
	  ################# MEET GUILD MASTER BEGIN ##############


	 ("met_the_guild_master",[
						(party_slot_eq, "$current_town", slot_party_type, spt_town),
						(party_get_slot, ":scene", "$current_town", slot_town_alley),	### mod edited 20.09.2018
						(try_begin),
						(scene_slot_eq, ":scene", slot_scene_visited, 0), #check if scene has been visited before to allow entry from menu. Otherwise scene will only be accessible from the town center.
							(disable_menu_option),
						(try_end),
									...
									(call_script, "script_get_meeting_scene_guild_master"),
									(assign, ":meeting_scene", reg0),
									(modify_visitors_at_site,":meeting_scene"),
									(reset_visitors),
									(set_visitor,40,"trp_player"),
									(party_get_slot,":guild_master","$current_town",slot_town_elder),
									(set_visitor,11,":guild_master"),
									(set_jump_mission,"mt_town_center"),
									(assign, "$talk_context", tc_town_talk),
									(jump_to_scene,":meeting_scene"),
									(change_screen_map_conversation, ":guild_master")
									],"That shouldn't be shown,Guild master"),

	################# MEET GUILD MASTER END ##############      
    ...
    [
      ...
      ("tournament_join_next_fight", [], "Fight in the next round.",
       [
           ...
           (try_begin),
             # (eq, ":town_original_faction", "fac_kingdom_1"),			#### mod edited 19.09.2018
             # #Swadia
           ...
           # (else_try),
             ...
             # (try_begin),
               # (eq, ":mod", 0),
              # (call_script, "script_set_items_for_tournament", 100, 40, 60, 0, 30, 30, 0, 0, "itm_arena_armor_red", "itm_tourney_helm_red"),
               (call_script, "script_set_items_for_tournament", 30, 30, 60, 50, 30, 30, 30, 30, "itm_arena_armor_red", "itm_tourney_helm_red"),            
			# (else_try),
               # (call_script, "script_set_items_for_tournament", 50, 0, 60, 0, 30, 30, 0, 0, "itm_arena_armor_red", "itm_tourney_helm_red"),
             # (try_end),
           (try_end),
           (jump_to_scene, ":arena_scene"),
           (change_screen_mission),
...
#COOP BEGIN Village train peasants against bandits#############################		  
      ("coop_setup",
       ...
       [
        ...
        (store_random_in_range, ":random_no", ":min_bandits", ":max_bandits"),
        (party_clear, "p_temp_wounded"), #use this party to temp make bandits
        (party_add_members, "p_temp_wounded", ":bandit_troop", ":random_no"),
	  ...
	  [
	    ...
	    (else_try),
	      ...
	      (else_try),
	        ...
	        (assign, ":scene_to_use", "scn_lair_desert_bandits"),	
	      (else_try),
	        (eq, ":starting_town_faction", "fac_kingdom_7"), #player selected Eques city as starting town.
	        (assign, ":scene_to_use", "scn_lair_forest_bandits"),			
		 (else_try),
	        (eq, ":starting_town_faction", "fac_kingdom_8"), #player selected Eques city as starting town.
	        (assign, ":scene_to_use", "scn_lair_forest_bandits"),			
	      (try_end),  
	    (try_end),
