...
###
      ...
      (try_begin),
        ...
        # (create_button_overlay, "$g_presentation_obj_coop_admin_panel_28", "@Send File to player", tf_center_justify),
        # (position_set_x, pos1, 825),
        # (position_set_y, pos1, 210),
        # (overlay_set_position, "$g_presentation_obj_coop_admin_panel_28", pos1),
        # (position_set_x, pos1, 1500),
        # (position_set_y, pos1, 1500),
        # (overlay_set_size, "$g_presentation_obj_coop_admin_panel_28", pos1),
    ...
    (ti_on_presentation_event_state_change,
     [(store_trigger_param_1, ":object"),
      ...
      # (else_try),
		...
		# (multiplayer_send_message_to_server, multiplayer_event_mod_send_file_to_player_request),
		# ### mod end     
	  (try_end),
      ]),
    ...
    (ti_on_presentation_event_state_change,
     [(store_trigger_param_1, ":object"),
      ...
      (else_try),
		...
		#(display_message,"@ requesting result"),
			(multiplayer_send_message_to_server, multiplayer_event_mod_send_file_to_player_request),
		(try_end),
		(call_script,"script_multiplayer_prepare_file", 1),
        (presentation_set_duration, 0),
        (start_presentation, "prsnt_coop_escape_menu"),
      (try_end),
