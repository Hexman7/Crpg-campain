...
meshes = [
  ...
  ("tableau_mesh_new_som_herladic", 0, "tableau_mesh_new_som_herladic",  0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("tableau_mesh_new_plated_som_herladic", 0, "tableau_mesh_new_plated_som_herladic",  0, 0, 0, 0, 0, 0, 1, 1, 1),
  
  ("tableau_mesh_barded_warhorse_heraldic_zagibu", 0, "tableau_mesh_barded_warhorse_heraldic_zagibu",  0, 0, 0, 0, 0, 0, 1, 1, 1),
  
  ("tableu_leather_gloves_b_banner", 0, "tableu_leather_gloves_b_banner",  0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("tableu_leather_gloves_b", 0, "tableu_leather_gloves_b",  0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("tableau_blue_tunic_over_mail", 0, "tableau_blue_tunic_over_mail",  0, 0, 0, 0, 0, 0, 1, 1, 1),
...
#INVASION MODE END
  ...
  ### mod begin
  ("party_window", 0, "party_window_b", 0, 0, 0, 0, 0, 0, 1, 1, 1),	#23.10.2018
  ("inventory_window", 0, "inventory_window_b", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("inventory_slot", 0, "inventory_slot", 0, 0, 0, 0, 0, 0, 1, 1, 1),
  ("inventory_window_hinge", 0, "inventory_window_hinge", 0, 0, 0, 0, 0, 0, 1, 1, 1),
