...
#       (cur_tableau_add_mesh, "mesh_banner_a01", pos1, 116, 0),
  ...
  ("heraldic_armor_e", 0, "sample_early_transitional_heraldic_banner", 512, 512, 0, 0, 0, 0,
   [
       (store_script_param, ":banner_mesh", 1),
...
#       (cur_tableau_add_mesh, "mesh_banner_a01", pos1, 116, 0),
   ...
   ("heraldic_armor_f", 0, "sample_new_som_herladic", 512, 512, 0, 0, 0, 0,
   [
       (store_script_param, ":banner_mesh", 1),
...
#       (cur_tableau_add_mesh, "mesh_banner_a01", pos1, 116, 0),
       ...
       (cur_tableau_add_mesh, "mesh_tableau_mesh_new_som_herladic", pos1, 0, 0),
       (cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000),
       ]),
   
   ("heraldic_armor_g", 0, "sample_new_plated_som_herladic", 512, 512, 0, 0, 0, 0,
   [
       (store_script_param, ":banner_mesh", 1),
...
#       (cur_tableau_add_mesh, "mesh_banner_a01", pos1, 116, 0),
       ...
       (cur_tableau_add_mesh, "mesh_tableau_mesh_new_plated_som_herladic", pos1, 0, 0),
       (cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000),
       ]),
	   
   ("heraldic_armor_h", 0, "sample_blue_tunic_over_mail", 512, 512, 0, 0, 0, 0,
   [
       (store_script_param, ":banner_mesh", 1),
...
#       (cur_tableau_add_mesh, "mesh_banner_a01", pos1, 116, 0),
       ...
       (cur_tableau_add_mesh, "mesh_tableau_blue_tunic_over_mail", pos1, 0, 0),
       (cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000),
       ]),

	  

  ("colored_gloves", 0, "sample_leather_gloves_banner", 512, 512, 0, 0, 0, 0,
   [
       (store_script_param, ":banner_mesh", 1),
       ...
       (init_position, pos1),
       (cur_tableau_add_mesh_with_vertex_color, "mesh_tableu_leather_gloves_b_banner", pos1, 200, 100, ":background_color"),
       (init_position, pos1),
        (position_set_z, pos1, -10),
        (position_set_x, pos1, 0),
...
# #       (cur_tableau_add_mesh, "mesh_banner_a01", pos1, 116, 0),
        (init_position, pos1),
        (position_set_z, pos1, 10),
        (cur_tableau_add_mesh, "mesh_tableu_leather_gloves_b", pos1, 0, 0),
        (cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000),
       ]),
