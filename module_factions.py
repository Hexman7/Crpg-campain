...
factions = [
  ...
  ("outlaws","Outlaws", max_player_rating(-30), 0.5,[("commoners",-0.6),("player_faction",-0.15),("neutrals",-0.15)], [], 0x888888),
# Factions before this point are hardwired into the game end their order should not be changed.
  ...
  ("neutrals","Neutral",0, 0.1,[("player_faction",0.0),("outlaws",-0.35),("peasant_rebels", -0.1),("deserters", -0.02),("mountain_bandits", -0.05),("forest_bandits", -0.05),("kingdom_1", -0.15),("kingdom_2", -0.15),("kingdom_3", -0.15),("kingdom_4", -0.15),("kingdom_5", -0.15),("kingdom_6", -0.15),("kingdom_7", -0.15),("kingdom_8", -0.15),("kingdom_9", -0.15)], [],0x999900),
  ("neutrals_culture",  "{!}neutrals_culture", 0, 0.9, [], []),
...
#  ("vaegir_caravans","Vaegir Caravans", 0, 0.5,[("outlaws",-0.8), ("dark_knights",-0.2)], []),
  ...
  ("kingdom_1",  "Kingdom of Polanie", 0, 0.9, [("neutrals",-0.5),("outlaws",-0.05),("peasant_rebels", -0.1),("deserters", -0.02),("mountain_bandits", -0.05),("forest_bandits", -0.05)], [], 0xcd0000),
  ("kingdom_2",  "Grey Order",    0, 0.9, [("neutrals",-0.5),("outlaws",-0.05),("peasant_rebels", -0.1),("deserters", -0.02),("mountain_bandits", -0.05),("forest_bandits", -0.05)], [], 0x696969),
  ("kingdom_3",  "Warriors of Tengri", 0, 0.9, [("neutrals",-0.5),("outlaws",-0.05),("peasant_rebels", -0.1),("deserters", -0.02),("mountain_bandits", -0.05),("forest_bandits", -0.05)], [], 0x0033FF),#0x0000FF
  ("kingdom_4",  "Kalmarunion",    0, 0.9, [("neutrals",-0.5),("outlaws",-0.05),("peasant_rebels", -0.1),("deserters", -0.02),("mountain_bandits", -0.05),("forest_bandits", -0.05)], [], 0xFFD700),
  ("kingdom_5",  "Druzhina",  0, 0.9, [("neutrals",-0.5),("outlaws",-0.05),("peasant_rebels", -0.1),("deserters", -0.02),("mountain_bandits", -0.05),("forest_bandits", -0.05)], [], 0xDC143C),	#FF0000
  ("kingdom_6",  "Templars",  0, 0.9, [("neutrals",-0.5),("outlaws",-0.05),("peasant_rebels", -0.1),("deserters", -0.02),("mountain_bandits", -0.05),("forest_bandits", -0.05)], [], 0xFFF0F5),
  ("kingdom_7",  "Eques",  0, 0.9, [("neutrals",-0.5),("outlaws",-0.05),("peasant_rebels", -0.1),("deserters", -0.02),("mountain_bandits", -0.05),("forest_bandits", -0.05)], [], 0x000000),
  ("kingdom_8",  "Norse",  0, 0.9, [("neutrals",-0.5),("outlaws",-0.05),("peasant_rebels", -0.1),("deserters", -0.02),("mountain_bandits", -0.05),("forest_bandits", -0.05)], [], 0x33CC99),
  ("kingdom_9",  "Order de l'Etoile",  0, 0.9, [("neutrals",-0.5),("outlaws",-0.05),("peasant_rebels", -0.1),("deserters", -0.02),("mountain_bandits", -0.05),("forest_bandits", -0.05)], [], 0x33DDDD),
...
##  ("rebel_peasants","Rebel Peasants", 0, 0.5,[("vaegirs",-0.5),("player_faction",0.0)], []),
  ...
  ("deserters","Deserters", 0, 0.5,[("neutrals",-0.2),("manhunters",-0.6),("merchants",-0.5),("player_faction",-0.1)], [], 0x888888),
  ("mountain_bandits","Mountain Bandits", 0, 0.5,[("neutrals",-0.2),("commoners",-0.2),("merchants",-0.5),("manhunters",-0.6),("player_faction",-0.15)], [], 0x888888),
  ("forest_bandits","Forest Bandits", 0, 0.5,[("neutrals",-0.2),("commoners",-0.2),("merchants",-0.5),("manhunters",-0.6),("player_faction",-0.15)], [], 0x888888),
